        ...
        <div className="flex-1 w-full space-y-8">
          ...
          <div className="flex flex-wrap gap-3 pt-8">
            <a
              ...
              className="flex items-center gap-3 rounded-md border border-[#3730A3] bg-white px-5 py-3 text-lg font-medium text-[#3730A3] transition-colors hover:bg-[#F4F2FF] dark:border-[#8F88FF] dark:bg-[#2D2A3E] dark:text-[#E2E2E2] dark:hover:bg-[#3A3652]"
            >
              <img
                src={githubIcon}
                alt="Github"
